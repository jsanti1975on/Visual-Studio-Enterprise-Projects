...
int main() {
    ...
    // Error handling for window class registration
    if (!RegisterClass(&wc)) {
    ...
    HWND hwnd = CreateWindowEx(
        0,
        CLASS_NAME,
        "j.a.s Desktop Cyber-Range Application",
        WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_COMMAND:
        ...
        case 2: // Show Commands button
            ...
            printf("1. Run 'ip cmds'.\n");
            printf("2. Open ESXi.\n");
            printf("3. Open a directory.\n");
            MessageBox(hwnd, 
